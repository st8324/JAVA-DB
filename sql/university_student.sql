...
CREATE TABLE `student` (
  ...
  `student_resident_num` varchar(45) DEFAULT NULL COMMENT '주민번호',
  `student_major` varchar(45) DEFAULT NULL COMMENT '전공',
  PRIMARY KEY (`student_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='학생 테이블';
...
INSERT INTO `student` VALUES (2017160001,'강감찬',22,3,1,NULL,NULL,NULL),(2019135135,'세종대왕',NULL,NULL,NULL,NULL,NULL,NULL),(2019160160,'홍길동',20,1,1,'청주','000301-300000','컴공');
